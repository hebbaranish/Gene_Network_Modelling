...
data=np.loadtxt("RACIPE/GRHL2_solution.dat")[:,2:]
...
if plot_plotterdata:
    dataplotter = open("output/{}_ssprob_all.txt".format("22_async_unweigh"),'r').read().split("\n")[1:-1]
    x_labels = []
    y_data = []
    # print(dataplotter)
...
plt.savefig("racipeVbool_22new2.png")
