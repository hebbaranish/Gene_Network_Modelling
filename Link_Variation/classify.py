...
data=np.loadtxt("RACIPE/OVOL2_solution.dat")[:,2:]
...
if plot_plotterdata:
    dataplotter = open("output/{}_ssprob_all.txt".format("OVOL2_async_unweigh"),'r').read().split("\n")[1:-1]
    x_labels = []
    y_data = []
    # print(dataplotter)
    ...
    plt.title( "JSD = {}".format(jensenshannon(final_ydata,np.array(final_yaxislist) )))
    plt.show()
    # print(final_ydata)
# print(xaxislabel)
...
plt.savefig("racipeVbool_23.png")
