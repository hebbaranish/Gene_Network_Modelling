...
*/
{
  ...
  f ( t + 3.0 * h / 8.0, f5, f2, p, topoinfo  );
  ...
  f ( t + 12.0 * h / 13.0, f5, f3, p, topoinfo  );
...
*/
      r4_fehl ( f, neqn, y, *t, h, yp, p, topoinfo, f1, f2, f3, f4, f5, f1 );
      nfe = nfe + 5;
/*
...
/*
  Advance an approximate solution over one step of length H.
*/
      r8_fehl ( f, neqn, y, *t, h, yp, p, topoinfo, f1, f2, f3, f4, f5, f1 );
      nfe = nfe + 5;
/*
  Compute and test allowable tolerances versus local error estimates
  and remove scaling of tolerances.  The relative error is
